...
Insert into HBM.BOOK (NO,SYMBOL,NAME,AUTHOR,PRICE,PUB,PUBDAY,LOC,IMGFILE,BRWER,BRWDAY,PERIOD) values (198,513145,'윤성우의 열혈 C++ 프로그래밍','윤성우',35000,'오렌지미디어',to_date('17/12/20','RR/MM/DD'),'문적원2','2_yoon_sung_woo_c++.jpg','전양훈',to_timestamp('17/12/20 19:48:12.245000000','RR/MM/DD HH24:MI:SSXFF'),to_date('17/12/20','RR/MM/DD'));
...
Insert into HBM.BOOK (NO,SYMBOL,NAME,AUTHOR,PRICE,PUB,PUBDAY,LOC,IMGFILE,BRWER,BRWDAY,PERIOD) values (227,513145,'윤성우의 열혈 C++ 프로그래밍','윤성우',35000,'오렌지미디어',to_date('17/12/20','RR/MM/DD'),'문적원2','2_yoon_sung_woo_c++.jpg','전양훈',to_timestamp('17/12/20 22:54:09.031000000','RR/MM/DD HH24:MI:SSXFF'),to_date('17/12/20','RR/MM/DD'));
--------------------------------------------------------
